...
const char* hostname = "Harpernode2";
const char* ssid = "120Mesh";
const char* password = "1801ca1326";
char* MQTTserver = "192.168.1.20";
String MQTTTopic = "Harper";
const char* MQTTSubscribe = "HarperWEBButton";
...
void loop() {
  ...
  if (OTAUPDATE) {
    ...
    t_httpUpdate_return ret = ESPhttpUpdate.update(wifiClient, "http://www.sechouse.tech/ota/Harpernode2.bin");
    // Or:
